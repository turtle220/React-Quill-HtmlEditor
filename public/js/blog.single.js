              ...
              <div className="blog-posts single-post">
              {
                ...
                <article className="post clearfix mb-0">
                  ...
                  <div className="entry-header">
                    ...
                    <br/>
                    <div className="post-thumb thumb"> <img src={`/images/blog/${blogDetails[0].image}`} alt="" className="img-responsive img-fullwidth" />  </div>
                  </div>
                  <div className="entry-content">
                    ...
                    <div dangerouslySetInnerHTML={{__html: blogDetails[0].description}}></div>
                  </div>
                  <div className="read">
